    ...
    <div class="BGIMG" >
        <div class="container">
                ...
                <div class="intro-lead-in" style="font-size: 50px; font-family: 'Times New Roman', Times, serif;position: absolute;left:550px;top:120px;color:White">
                    <span><b><img src="assets/fonts/exchange-alt-solid.svg" alt="img-error" height="100">&nbsp;&nbsp; All Transactions</b></span></div>
        ...
        <section class="article-list1" style="color:white;position: relative;left:120px;top:120px;">
                ...
                <div class="row articles"> 
                    ...
                    <div class="col-sm-6 col-md-4 item">
                        ...
                        <img src="assets/fonts/success.svg" height="60px" width="60px" stylt="padding:100px">

                        @else
                        <img src="assets/fonts/fail.svg" height="60px" width="60px" stylt="padding:100px">
                        @endif

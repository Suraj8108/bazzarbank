...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/bootstrap/css/Login-Form-Dark.css') }}">
</head>
    ...
    <div CLASS="BGIMG">
        <div class="container">
                ...
                <div class="intro-lead-in" style="font-size: 50px; font-family: 'Times New Roman', Times, serif;position: absolute;left:550px;top:120px;color:White">
                    <span><b><img src="{{ asset('assets/fonts/money-bill-alt-solid.svg') }}" alt="img-error" height="100">&nbsp;&nbsp; Money Transfer</b></span></div>
                ...
                @if(Session::has('orderId'))
                    ...
                    <form action="/afterpayement" method="POST">
                        ...
                        <script
                            ...
                            data-image="{{ asset('assets/img/bazzarbank.jpeg') }}"
